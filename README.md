...
* AVG and Avast flag the foundry module for iframe injection. This is probably because it utilizes iframes a lot. To still use the module you should whitelist <!-- insert_js_url_start -->[inlineviewer.js](https://www.virustotal.com/gui/file-analysis/MjUxODJlNTAyNjUxM2Y5ZGE2MmMyOTRhZTE4OGQ0ZWE6MTYyMDAwNTkxNg==/detection)<!-- insert_js_url_end --> and <!-- insert_html_url_start -->[inlineviewer.html](https://www.virustotal.com/gui/file-analysis/MWJjMThiNDI2MWRkYjlmMGUwODI3ZTZkNDZkNzkyZjY6MTYyMDAwNTkxNw==/detection)<!-- insert_html_url_end -->
