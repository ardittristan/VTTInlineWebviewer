...
* AVG and Avast flag the foundry module for iframe injection. This is probably because it utilizes iframes a lot. To still use the module you should whitelist <!-- insert_js_url_start -->[inlineviewer.js](https://www.virustotal.com/gui/file-analysis/MThhOWFmZWU0ZjY3ZmZhN2JjYjkxMmRiZTgwNjVhMWE6MTYxNzczMjIxMg==/detection)<!-- insert_js_url_end --> and <!-- insert_html_url_start -->[inlineviewer.html](https://www.virustotal.com/gui/file-analysis/YjI4YTgzMWRhMjkzYWRlOTgzODZiZGIyYTFiMmIyZTA6MTYxNzczMjIxMg==/detection)<!-- insert_html_url_end -->
