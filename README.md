...
* AVG and Avast flag the foundry module for iframe injection. This is probably because it utilizes iframes a lot. To still use the module you should whitelist <!-- insert_js_url_start -->[inlineviewer.js](https://www.virustotal.com/gui/file-analysis/NTJkYWI1ZGE0NTRkY2QwMWNmNjVjMGE1NzZjYjJkMWU6MTYxODE1MjYzNQ==/detection)<!-- insert_js_url_end --> and <!-- insert_html_url_start -->[inlineviewer.html](https://www.virustotal.com/gui/file-analysis/YjQ2OGIwYmI1Mzg2NmIzYTRiZmMwZTY3Yzg4NjNjMjY6MTYxODE1MjYzNQ==/detection)<!-- insert_html_url_end -->
